...
//		Graphs.predecessorListOf(null, null)
	...
	public List<Fermata> fermateRaggiungibili(Fermata partenza) {
		...
		bfv.addTraversalListener(new TraversalListener<Fermata, DefaultEdge>() { //nuova classe inline
...
//		DepthFirstIterator<Fermata, DefaultEdge> dfv = new DepthFirstIterator<>(this.grafo, partenza) ;
	...
	public Fermata trovaFermata(String nome) { //metodo che restituisce oggetto Fermata dato il codiceFermata
